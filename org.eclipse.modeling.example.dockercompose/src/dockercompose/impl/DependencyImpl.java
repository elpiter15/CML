...
public class DependencyImpl extends MinimalEObjectImpl.Container implements Dependency {
	...
	protected EClass eStaticClass() {
		return DockercomposePackage.Literals.DEPENDENCY;
	}
		...
		if (service != null && service.eIsProxy()) {
			...
			if (service != oldService) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, DockercomposePackage.DEPENDENCY__SERVICE, oldService, service));
			}
		}
		return service;
	}
	...
	public void setService(Service newService) {
		...
		service = newService;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DockercomposePackage.DEPENDENCY__SERVICE, oldService, service));
	}
