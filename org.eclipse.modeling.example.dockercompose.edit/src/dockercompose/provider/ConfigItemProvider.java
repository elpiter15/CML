...
/**
 * This is the item provider adapter for a {@link dockercompose.Config} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ConfigItemProvider 
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addConfig_namePropertyDescriptor(object);
		}
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 DockercomposePackage.Literals.CONFIG__NAME,
				 true,
				 false,
				 false,
	...
	protected void addFilePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Config_file_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Config_file_feature", "_UI_Config_type"),
				 DockercomposePackage.Literals.CONFIG__FILE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addExternalPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Config_external_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Config_external_feature", "_UI_Config_type"),
				 DockercomposePackage.Literals.CONFIG__EXTERNAL,
				 true,
				 false,
				 false,
	 ...
	 * @generated
	 */
	protected void addConfig_namePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Config_config_name_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Config_config_name_feature", "_UI_Config_type"),
				 DockercomposePackage.Literals.CONFIG__CONFIG_NAME,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
