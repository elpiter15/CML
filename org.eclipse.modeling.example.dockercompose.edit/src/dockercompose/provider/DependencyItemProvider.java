...
/**
 * This is the item provider adapter for a {@link dockercompose.Dependency} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DependencyItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Dependency_service_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Dependency_service_feature", "_UI_Dependency_type"),
				 DockercomposePackage.Literals.DEPENDENCY__SERVICE,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addConditionPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Dependency_condition_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Dependency_condition_feature", "_UI_Dependency_type"),
				 DockercomposePackage.Literals.DEPENDENCY__CONDITION,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		Condition labelValue = ((Dependency)object).getCondition();
