...
/**
 * This is the item provider adapter for a {@link dockercompose.Link} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class LinkItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Link_service_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Link_service_feature", "_UI_Link_type"),
				 DockercomposePackage.Literals.LINK__SERVICE,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 DockercomposePackage.Literals.LINK__ALIAS,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		String label = ((Link)object).getAlias();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Link.class)) {
			case DockercomposePackage.LINK__ALIAS:
