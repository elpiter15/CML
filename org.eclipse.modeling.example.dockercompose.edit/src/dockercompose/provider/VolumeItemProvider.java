...
/**
 * This is the item provider adapter for a {@link dockercompose.Volume} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class VolumeItemProvider 
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addVolume_namePropertyDescriptor(object);
		}
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 DockercomposePackage.Literals.VOLUME__NAME,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 DockercomposePackage.Literals.VOLUME__DRIVER,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addExternalPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Volume_external_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Volume_external_feature", "_UI_Volume_type"),
				 DockercomposePackage.Literals.VOLUME__EXTERNAL,
				 true,
				 false,
				 false,
	 ...
	 * @generated
	 */
	protected void addVolume_namePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Volume_volume_name_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Volume_volume_name_feature", "_UI_Volume_type"),
				 DockercomposePackage.Literals.VOLUME__VOLUME_NAME,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(DockercomposePackage.Literals.VOLUME__DRIVER_OPTS);
			childrenFeatures.add(DockercomposePackage.Literals.VOLUME__LABELS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(DockercomposePackage.Literals.VOLUME__DRIVER_OPTS,
				 DockercomposeFactory.eINSTANCE.createVolumeDriverOpt()));

		newChildDescriptors.add
			(createChildParameter
				(DockercomposePackage.Literals.VOLUME__LABELS,
				 DockercomposeFactory.eINSTANCE.createVolumeLabel()));
	}
